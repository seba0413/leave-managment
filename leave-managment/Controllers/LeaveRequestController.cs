    ...
    public class LeaveRequestController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var model = new AdminLeaveRequestViewVM
            {
                ...
                PendingRequests = leaveRequestsModel.Count(q => q.Approved == true),
        ...
        {
            return ApproveOrRejectRequest(id, false);
        }

        private ActionResult ApproveOrRejectRequest(int id, bool status)
        {
            try
            {
                var user = _userManager.GetUserAsync(User).Result;
